...
<head>
    ...
    <title>Éclat Joias - Anéis de Prata</title>
...
document.addEventListener('DOMContentLoaded', function() {
   ...
   <a href="../index/carrinho.php"> 
    ...
    <section class="catalogo">
        ...
        <div id="caprice" class="collection-section section-prata">
            <h2>Coleção Caprice</h2>
            <p>A pureza da prata 925 e o brilho dos cristais. Joias inspiradas no charme atemporal da alta costura.</p>

            <div class="cards-grid" role="list" aria-label="Anéis da Coleção Caprice">
