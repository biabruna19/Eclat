<?php
// ARQUIVO: index/brincosPratas.php
...
function getFavoritesFromCookie() {
    if (isset($_COOKIE[FAVORITES_KEY])) {
        ...
        return is_array($favoritos) ? $favoritos : [];
    }
    return [];
}
...
<head>
    ...
    <title>Éclat Joias - Brincos de Prata</title>
...
document.addEventListener('DOMContentLoaded', function() {
   ...
   <a href="../index/carrinho.php"> 
            ...
            <div id="carousel-wrapper" class="flex transition-transform duration-500 ease-in-out">
                ...
                <div class="carousel-item w-full flex-shrink-0 relative" role="group" aria-label="Slide 2 de 3">
                    <img src="../imagens/Brincos/brincos.png"
                        class="w-full h-full object-cover" alt="Banner de Brincos Prata" loading="lazy">
                </div>
    ...
    <section class="catalogo">
        ...
        <div id="monaco" class="collection-section section-dourado">
            <h2>Coleção Monaco</h2>
            <p>Prata em sua forma mais pura. Brincos que unem sofisticação e simplicidade em perfeita harmonia.</p>

            <div class="cards-grid" role="list" aria-label="Brincos da Coleção Monaco">
