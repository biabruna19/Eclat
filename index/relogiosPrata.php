<?php
// ARQUIVO: index/relogiosPrata.php
...
// Relógios Prateados - Coleção Robuste
// ----------------------------------------------------------------------------------
$PRODUTOS_PRATA = [
    [
...
<head>
    ...
    <title>Éclat Joias - Relógios Prateados</title>
...
document.addEventListener('DOMContentLoaded', function() {
   ...
   <a href="../index/carrinho.php"> 
        ...
        <div class="relative h-64 md:h-96 overflow-hidden">
            <div id="carousel-wrapper" class="flex transition-transform duration-500 ease-in-out">
                ...
                <div class="carousel-item w-full flex-shrink-0 relative" role="group" aria-label="Slide 1 de 3">
                    <img src="../imagens/Relogios/robuste.png"
                        class="w-full h-full object-cover" alt="Banner Relógios Robuste" loading="lazy">
                </div>

                <div class="carousel-item w-full flex-shrink-0 relative" role="group" aria-label="Slide 2 de 3">
                    <img src="../imagens/Relogios/relogios.png"
                        class="w-full h-full object-cover" alt="Banner de Relógios" loading="lazy">
                </div>

                <div class="carousel-item w-full flex-shrink-0 relative" role="group" aria-label="Slide 3 de 3">
                    <img src="../imagens/Relogios/délicate.png"
                        class="w-full h-full object-cover" alt="Banner Relógios Délicate" loading="lazy">
                </div>
            </div>
        </div>
    ...
    <section class="catalogo">
        ...
        <div id="robuste" class="collection-section section-prata">
            <h2>Coleção Robuste</h2>
            <p>Relógios com caixa de aço em tons prateados que unem força, precisão e estilo atemporal.</p>

            <div class="cards-grid" role="list" aria-label="Relógios da Coleção Robuste">
                
                <?php foreach ($PRODUTOS_PRATA as $produto): 
                ...
                <div class="card card-dourado" 
                    ...
                    <img src="<?= htmlspecialchars($produto['img']) ?>" alt="Relógio <?= htmlspecialchars($produto['nome']) ?>" loading="lazy">
