<?php
// ARQUIVO: index/braceletesPrata.php
...
// Braceletes Prata - Coleção Aurore
// ----------------------------------------------------------------------------------
$PRODUTOS_PRATA = [
    [
...
<head>
    ...
    <title>Éclat Joias - Braceletes de Prata</title>
...
document.addEventListener('DOMContentLoaded', function() {
   ...
   <a href="../index/carrinho.php"> 
    ...
    <section class="catalogo">
        ...
        <div id="aurore" class="collection-section section-prata">
            <h2>Coleção Aurore</h2>
            <p>A pureza da Prata 925 em designs que capturam a beleza da Aurora. Joias que brilham com uma luz suave e atemporal.</p>

            <div class="cards-grid" role="list" aria-label="Braceletes da Coleção Aurore">
