<?php
// ARQUIVO: index/relogioDourado.php
...
// Relógios Dourados - Coleção Délicate
// ----------------------------------------------------------------------------------
$PRODUTOS_DOURADO = [
    [
...
<head>
    ...
    <title>Éclat Joias - Relógios Dourados</title>
...
document.addEventListener('DOMContentLoaded', function() {
   ...
   <a href="../index/carrinho.php"> 
    ...
    <section class="catalogo">
        ...
        <div id="delicate" class="collection-section section-dourado">
            <h2>Coleção Délicate</h2>
            <p>Relógios banhados a ouro 18k, que unem a delicadeza de um design fino com a resistência de uma peça eterna.</p>

            <div class="cards-grid" role="list" aria-label="Relógios da Coleção Délicate">
